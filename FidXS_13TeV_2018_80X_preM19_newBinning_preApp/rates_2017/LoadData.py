...
dirData_94 ='/eos/cms/store/group/phys_muon/TagAndProbe/HZZ4L/2017/sig_slimmed/'

print "data  directory: ", dirData_94

dirMC_94 = '/eos/cms/store/group/phys_muon/TagAndProbe/HZZ4L/2017/sig_slimmed/'    #  
...
SamplesMC_94 = [
'GluGluToContinToZZTo2e2mu_M125_2017_new_slimmed.root',
'GluGluToContinToZZTo4mu_M125_2017_new_slimmed.root',
'GluGluToContinToZZTo4e_M125_2017_new_slimmed.root',
'ZZTo4L_M125_2017_slimmed.root'
]

SamplesData_94 = [
'2017_noDuplicates_slimmed.root',
]
###################################################### 
RootFile = {} 
Tree = {} 
