...
obsName = 'mass4l'
_temp = __import__('inputs_sig_mass4l', globals(), locals(), ['acc','dacc','eff','deff','outinratio','doutinratio','inc_wrongfrac'], -1)
#_temp = __import__('inputs_sig_'+obsName+'_test', globals(), locals(), ['acc','dacc','eff','deff','outinratio','doutinratio','inc_wrongfrac'], -1)
#_temp = __import__('inputs_sig_mass4l_Run1Fid_dataMC', globals(), locals(), ['acc','dacc','eff','deff','outinratio','doutinratio','inc_wrongfrac'], -1)
#_temp = __import__('inputs_sig_mass4l_Run2Fid_dataMC', globals(), locals(), ['acc','dacc','eff','deff','outinratio','doutinratio','inc_wrongfrac'], -1)
#_temp = __import__('inputs_sig_mass4l_Run1Fid_dataMC_HRes', globals(), locals(), ['acc','dacc','eff','deff','outinratio','doutinratio','inc_wrongfrac'], -1)
#_temp = __import__('inputs_sig_'+obsName, globals(), locals(), ['acc','dacc','eff','deff','outinratio','doutinratio','inc_wrongfrac'], -1)
acc = _temp.acc
dacc = _temp.dacc
eff = _temp.eff
deff = _temp.deff
...
for tabletype in ['SM','Exo']:
    ...
    for long in sample_shortnames.keys():
        ...
        line = line + '%.3f'%acc[short+'_4l_'+obsName+'_genbin0_recobin0']+' $\pm$ %.3f'%dacc[short+'_4l_'+obsName+'_genbin0_recobin0']+' & '
#        line = line + '%.3f'%acc[short+'_4l_'+obsName+'_genbin0_recobin0']+' & '
        line = line + '%.3f'%eff[short+'_4l_'+obsName+'_genbin0_recobin0']+' $\pm$ %.3f'%deff[short+'_4l_'+obsName+'_genbin0_recobin0']+' & '
        line = line + '%.3f'%outinratio[short+'_4l_'+obsName+'_genbin0_recobin0']+' $\pm$ %.3f'%doutinratio[short+'_4l_'+obsName+'_genbin0_recobin0']+' & '
        deff1pfout = sqrt( ((1+outinratio[short+'_4l_'+obsName+'_genbin0_recobin0'])*deff[short+'_4l_'+obsName+'_genbin0_recobin0'])**2 + (eff[short+'_4l_'+obsName+'_genbin0_recobin0']*doutinratio[short+'_4l_'+obsName+'_genbin0_recobin0'])**2 )
        line = line + '%.3f'%(eff[short+'_4l_'+obsName+'_genbin0_recobin0']*(1+outinratio[short+'_4l_'+obsName+'_genbin0_recobin0']))+' $\pm$ %.3f'%deff1pfout+' \\\\ \n '
        table += line
    print table
    print '\\hline \\hline'
    print '\end{tabular}'
