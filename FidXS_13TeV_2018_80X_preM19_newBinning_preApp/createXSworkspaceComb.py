...
def createXSworkspaceComb(obsName, channel, nBins, obsBin, observableBins, usecfactor, addfakeH, modelName, physicalModel,doComb):
    ...
    if (obsName!="mass4lREFIT"):
        if (channel=='2e2mu'):
            ...
            CMS_zz4l_alpha_3_centralValue = RooFormulaVar("CMS_zz4l_alpha_3_centralValue","CMS_zz4l_alpha_3_centralValue","(0.905389+(0.0029819)*(@0-125))",RooArgList(MH))
            CMS_zz4l_n_3_8_centralValue = RooFormulaVar("CMS_zz4l_n_3_8_centralValue","CMS_zz4l_n_3_8_centralValue","(3.90164+(0)*(@0-125))*(1+@1)",RooArgList(MH,CMS_zz4l_n_sig_3_8))
            CMS_zz4l_alpha2_3_centralValue = RooFormulaVar("CMS_zz4l_alpha2_3_centralValue","CMS_zz4l_alpha2_3_centralValue","(1.5737+(0.00776476)*(@0-125))",RooArgList(MH))
            CMS_zz4l_n2_3_8_centralValue = RooFormulaVar("CMS_zz4l_n2_3_8_centralValue","CMS_zz4l_n2_3_8_centralValue","(4.33416+(0)*(@0-125))",RooArgList(MH))
        ...
        if (channel=='4e'):
            ...
            CMS_zz4l_alpha_2_centralValue = RooFormulaVar("CMS_zz4l_alpha_2_centralValue","CMS_zz4l_alpha_2_centralValue","(0.778691+(-0.00177387)*(@0-125))",RooArgList(MH))
            CMS_zz4l_n_2_8_centralValue = RooFormulaVar("CMS_zz4l_n_2_8_centralValue","CMS_zz4l_n_2_8_centralValue","(6.85936+(0)*(@0-125))*(1+@1)",RooArgList(MH,CMS_zz4l_n_sig_2_8))
            CMS_zz4l_alpha2_2_centralValue = RooFormulaVar("CMS_zz4l_alpha2_2_centralValue","CMS_zz4l_alpha2_2_centralValue","(1.47389+(0.00503384)*(@0-125))",RooArgList(MH))
            CMS_zz4l_n2_2_8_centralValue = RooFormulaVar("CMS_zz4l_n2_2_8_centralValue","CMS_zz4l_n2_2_8_centralValue","(7.24158+(0)*(@0-125))",RooArgList(MH))

        if (channel=='4mu'):

            CMS_zz4l_mean_sig_1_8_centralValue = RooFormulaVar("CMS_zz4l_mean_sig_1_8_centralValue","CMS_zz4l_mean_sig_1_8_centralValue", \
                                                                   "(124.801+(-0.00230642+1)*(@0-125)) + @0*@1*@2",RooArgList(MH,CMS_zz4l_mean_m_sig,CMS_zz4l_mean_m_err_1_8))
            ...
            CMS_zz4l_alpha_1_centralValue = RooFormulaVar("CMS_zz4l_alpha_1_centralValue","CMS_zz4l_alpha_1_centralValue","(1.29006+(-0.0040219)*(@0-125))",RooArgList(MH))
            CMS_zz4l_n_1_8_centralValue = RooFormulaVar("CMS_zz4l_n_1_8_centralValue","CMS_zz4l_n_1_8_centralValue","(2.1216+(0)*(@0-125))*(1+@1)",RooArgList(MH,CMS_zz4l_n_sig_1_8))
            CMS_zz4l_alpha2_1_centralValue = RooFormulaVar("CMS_zz4l_alpha2_1_centralValue","CMS_zz4l_alpha2_1_centralValue","(1.90093+(-0.0017352)*(@0-125))",RooArgList(MH))
            CMS_zz4l_n2_1_8_centralValue = RooFormulaVar("CMS_zz4l_n2_1_8_centralValue","CMS_zz4l_n2_1_8_centralValue","(2.7194+(0)*(@0-125))",RooArgList(MH))
    ...
    for genbin in range(nBins-1):
        if (physicalModel=="v3"):
            ...
            if (doComb):
                # SM value
                SigmaSMBin[str(genbin)] = RooRealVar('SigmaSMBin'+str(genbin), 'SigmaSMBin'+str(genbin), fidxs['4l'])
                # Free floating POI (=1.0 for SM)
                SigmaBin[str(genbin)] = RooRealVar('SigmaBin'+str(genbin), 'SigmaBin'+str(genbin), 1.0, 0.0, 500.0)                
                SigmaHBin['4e'+str(genbin)] = RooFormulaVar("Sigma4eBin"+str(genbin),"(@0*@3*@1*@2)", RooArgList(SigmaBin[str(genbin)], fracSM4eBin[str(genbin)], K1Bin[str(genbin)],SigmaSMBin[str(genbin)]))
                SigmaHBin['4mu'+str(genbin)] = RooFormulaVar("Sigma4muBin"+str(genbin),"(@0*@5*(1.0-@1*@2)*@3*@4/(1.0-@1) )", RooArgList(SigmaBin[str(genbin)], fracSM4eBin[str(genbin)], K1Bin[str(genbin)], K2Bin[str(genbin)], fracSM4muBin[str(genbin)], SigmaSMBin[str(genbin)]))
                SigmaHBin['2e2mu'+str(genbin)] = RooFormulaVar("Sigma2e2muBin"+str(genbin),"(@0*@5*(1.0-@1*@2)*(1.0-@3*@4/(1.0-@1)))", RooArgList(SigmaBin[str(genbin)], fracSM4eBin[str(genbin)], K1Bin[str(genbin)], K2Bin[str(genbin)], fracSM4muBin[str(genbin)], SigmaSMBin[str(genbin)]))
            else:
            ...
            # SM value
            rBin_channelSM[str(genbin)] = RooRealVar("r"+channel+"SMBin"+str(genbin),"r"+channel+"SMBin"+str(genbin), fidxs[channel])
            rBin_channelSM[str(genbin)].setConstant(True)
            if (doComb):
                rBin_channel[str(genbin)] = RooRealVar("r"+channel+"Bin"+str(genbin),"r"+channel+"Bin"+str(genbin), 1.0, 0.0, 500.0)    
            else:
            ...
            if (obsName == "nJets" or ("jet" in obsName)):
                if (dobComb):
                    trueH_norm_final[genbin] = RooFormulaVar("trueH"+channel+"Bin"+str(genbin)+recobin+"_final","@0*@1*@2*(1-@3)*@4", RooArgList(rBin_channel[str(genbin)], fideff_var[genbin],lumi,JES_sig_rfv,rBin_channelSM[str(genbin)]))
                else:
                ...
                if (doComb):
                    trueH_norm_final[genbin] = RooFormulaVar("trueH"+channel+"Bin"+str(genbin)+recobin+"_final","@0*@1*@2*@3", RooArgList(rBin_channel[str(genbin)], fideff_var[genbin],lumi,rBin_channelSM[str(genbin)]))
                else:
