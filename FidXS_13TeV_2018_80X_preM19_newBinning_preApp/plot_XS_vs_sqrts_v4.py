...
graphs_list = {
    ...
    'measured':{
        'x_values': [7,8,13],
        'central' : [0.555, 1.106, 2.904],
        'uncerUp' : [0.701, 0.433, 0.548],
        'uncerDn' : [0.446,0.360, 0.489],
    ...
    'measured_sys':{
        'x_values': [7,8,13],
        'central' : [0.555, 1.106, 2.904],
        'uncerUp' : [0.212,0.1392444, 0.272],
        'uncerDn' : [0.061,0.0958697, 0.215],
    ...
    'theory_hres2':{
        ...
        'uncerUp' : [0.125,0.143,0.156],
        'uncerDn' : [0.125,0.143,0.156],
        'setup' : {'color': kAzure+2, 'linestyle': kDashed ,'linewidth': 3, 'fillstyle' : 3004, 'draw_opt' : "E2" },
        'legend' : {'text': "Standard model (m_{H} = 125 GeV, N^{3}LO gg#rightarrow H)", 'draw_opt' : 'fl'}
            },
