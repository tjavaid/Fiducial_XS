    ...
    if (obsName!="mass4lREFIT"):
        if (channel=='2e2mu'):
            ...
            CMS_zz4l_mean_sig_3_8_centralValue = RooFormulaVar("CMS_zz4l_mean_sig_3_8_centralValue","CMS_zz4l_mean_sig_3_8_centralValue", \
                                                                   "(124.271022176+(0.995466623209)*(@0-125)) + (@0*@1*@3 + @0*@2*@4)/2", \
            ...
            CMS_zz4l_sigma_sig_3_8_centralValue = RooFormulaVar("CMS_zz4l_sigma_sig_3_8_centralValue","CMS_zz4l_sigma_sig_3_8_centralValue",\
                                                                    "(1.59054183214+(0.00859565153028)*(@0-125))*(TMath::Sqrt((1+@1)*(1+@2)))",RooArgList(MH,CMS_zz4l_sigma_m_sig,CMS_zz4l_sigma_e_sig))                                                          
#            CMS_zz4l_alpha_3_centralValue = RooFormulaVar("CMS_zz4l_alpha_3_centralValue","CMS_zz4l_alpha_3_centralValue","(0.95876381834)")#, RooArgList(quickfix))
            CMS_zz4l_alpha_3_centralValue = RooRealVar("CMS_zz4l_alpha_3_centralValue","CMS_zz4l_alpha_3_centralValue",0.95876381834)
            CMS_zz4l_n_3_8_centralValue = RooFormulaVar("CMS_zz4l_n_3_8_centralValue","CMS_zz4l_n_3_8_centralValue","(3.34594192822+(-0.0448460240194)*(@0-125))*(1+@1)",RooArgList(MH,CMS_zz4l_n_sig_3_8))


#            CMS_zz4l_alpha2_3_centralValue = RooFormulaVar("CMS_zz4l_alpha2_3_centralValue","CMS_zz4l_alpha2_3_centralValue","(1.51964172608)")#,RooArgList(MH))
	    CMS_zz4l_alpha2_3_centralValue=RooRealVar("CMS_zz4l_alpha2_3_centralValue","CMS_zz4l_alpha2_3_centralValue",1.51964172608)
#            CMS_zz4l_n2_3_8_centralValue = RooFormulaVar("CMS_zz4l_n2_3_8_centralValue","CMS_zz4l_n2_3_8_centralValue","(5.36918425072)")#, RooArgList(MH))
	    CMS_zz4l_n2_3_8_centralValue=RooRealVar("CMS_zz4l_n2_3_8_centralValue","CMS_zz4l_n2_3_8_centralValue",5.36918425072)

        if (channel=='4e'):

            CMS_zz4l_mean_sig_2_8_centralValue = RooFormulaVar("CMS_zz4l_mean_sig_2_8_centralValue","CMS_zz4l_mean_sig_2_8_centralValue", \
                                                                   "(123.584470977+(0.985479641584)*(@0-125)) + @0*@1*@2", \
            ...
            CMS_zz4l_sigma_sig_2_8_centralValue = RooFormulaVar("CMS_zz4l_sigma_sig_2_8_centralValue","CMS_zz4l_sigma_sig_2_8_centralValue", \
                                                                    "(2.06513490198+(0.0170904637944)*(@0-125))*(1+@1)",RooArgList(MH,CMS_zz4l_sigma_e_sig))
                                                          
#            CMS_zz4l_alpha_2_centralValue = RooFormulaVar("CMS_zz4l_alpha_2_centralValue","CMS_zz4l_alpha_2_centralValue","(0.948141039985)") #,RooArgList(MH))
            CMS_zz4l_alpha_2_centralValue = RooRealVar("CMS_zz4l_alpha_2_centralValue","CMS_zz4l_alpha_2_centralValue",0.948141039985) #,RooArgList(MH))
#            CMS_zz4l_n_2_8_centralValue = RooFormulaVar("CMS_zz4l_n_2_8_centralValue","CMS_zz4l_n_2_8_centralValue","(4.50550099253)") #,RooArgList(MH,CMS_zz4l_n_sig_2_8))
            CMS_zz4l_n_2_8_centralValue = RooRealVar("CMS_zz4l_n_2_8_centralValue","CMS_zz4l_n_2_8_centralValue",4.50550099253) #,RooArgList(MH,CMS_zz4l_n_sig_2_8))
#            CMS_zz4l_alpha2_2_centralValue = RooFormulaVar("CMS_zz4l_alpha2_2_centralValue","CMS_zz4l_alpha2_2_centralValue","(1.50089864206)")#,RooArgList(MH))
            CMS_zz4l_alpha2_2_centralValue = RooRealVar("CMS_zz4l_alpha2_2_centralValue","CMS_zz4l_alpha2_2_centralValue",1.50089864206)#,RooArgList(MH))
            CMS_zz4l_n2_2_8_centralValue = RooFormulaVar("CMS_zz4l_n2_2_8_centralValue","CMS_zz4l_n2_2_8_centralValue","(8.418376849+(0.219799725391)*(@0-125))",RooArgList(MH))

        if (channel=='4mu'):

            CMS_zz4l_mean_sig_1_8_centralValue = RooFormulaVar("CMS_zz4l_mean_sig_1_8_centralValue","CMS_zz4l_mean_sig_1_8_centralValue", \
                                                                   "(124.848593679+(0.999804660589)*(@0-125)) + @0*@1*@2",RooArgList(MH,CMS_zz4l_mean_m_sig,CMS_zz4l_mean_m_err_1_8))
            ...
            CMS_zz4l_sigma_sig_1_8_centralValue = RooFormulaVar("CMS_zz4l_sigma_sig_1_8_centralValue","CMS_zz4l_sigma_sig_1_8_centralValue", \
                                                                    "(1.16178876726+(0.00941312556444)*(@0-125))*(1+@1)",RooArgList(MH,CMS_zz4l_sigma_m_sig))                                                          

#            CMS_zz4l_alpha_1_centralValue = RooFormulaVar("CMS_zz4l_alpha_1_centralValue","CMS_zz4l_alpha_1_centralValue","(1.24564784663)") #RooArgList(MH))
            CMS_zz4l_alpha_1_centralValue = RooRealVar("CMS_zz4l_alpha_1_centralValue","CMS_zz4l_alpha_1_centralValue",1.24564784663) #RooArgList(MH))
#            CMS_zz4l_n_1_8_centralValue = RooFormulaVar("CMS_zz4l_n_1_8_centralValue","CMS_zz4l_n_1_8_centralValue","(2.07512754037)")#RooArgList(MH,CMS_zz4l_n_sig_1_8))
            CMS_zz4l_n_1_8_centralValue = RooRealVar("CMS_zz4l_n_1_8_centralValue","CMS_zz4l_n_1_8_centralValue",2.07512754037)#RooArgList(MH,CMS_zz4l_n_sig_1_8))
#            CMS_zz4l_alpha2_1_centralValue = RooFormulaVar("CMS_zz4l_alpha2_1_centralValue","CMS_zz4l_alpha2_1_centralValue","(1.73004748217)")#RooArgList(MH))
            CMS_zz4l_alpha2_1_centralValue = RooRealVar("CMS_zz4l_alpha2_1_centralValue","CMS_zz4l_alpha2_1_centralValue",1.73004748217)#RooArgList(MH))
#            CMS_zz4l_n2_1_8_centralValue = RooFormulaVar("CMS_zz4l_n2_1_8_centralValue","CMS_zz4l_n2_1_8_centralValue","(3.46206881262)")#RooArgList(MH))
            CMS_zz4l_n2_1_8_centralValue = RooRealVar("CMS_zz4l_n2_1_8_centralValue","CMS_zz4l_n2_1_8_centralValue",3.46206881262)#RooArgList(MH))
