...
graphs_list = {
    ...
    'measured':{
        'x_values': [7,8,13],
##        'central' : [0.557, 1.111, 2.915],
#        'central' : [0.557, 1.111, 2.772],
        'central' : [0.557, 1.111, 2.769],
##        'uncerUp' : [0.700, 0.431, 0.553],
#        'uncerUp' : [0.700, 0.431, 0.508],
        'uncerUp' : [0.700, 0.431, 0.434],
##        'uncerDn' : [0.444,0.360, 0.504],
#        'uncerDn' : [0.444,0.360,0.467],
        'uncerDn' : [0.444,0.360, 0.392],
...
#        'legend' : {'text': "Data (stat. #oplus sys. unc.)", 'draw_opt' : 'EP'}
        'legend' : {'text': "7-8 TeV Data,13 TeV Toy Data (stat. #oplus sys. unc.)", 'draw_opt' : 'EP'}
            },
...
#        'central' : [0.557, 1.111, 2.772],
        'central' : [0.557, 1.111, 2.769],
#        'uncerUp' : [0.211,0.136224, 0.2607067317888052],
        'uncerUp' : [0.211,0.136224, 0.25662423891752706],
##        'uncerDn' : [0.059,0.090408, 0.23596609926004203],
        'uncerDn' : [0.059,0.090408, 0.21312672286693665],
    ...
    'model_dependancy':{
        'x_values': [7,8,13],
#        'central' : [0.557, 1.111, 2.904],
#        'central' : [0.557, 1.111, 2.772],
        'central' : [0.557, 1.111, 2.769],
#        'uncerUp' : [0.00, 0.00, 0.006],
        'uncerUp' : [0.00, 0.00, 0.009],
#        'uncerDn' : [0.00, 0.00, 0.026],
        'uncerDn' : [0.00, 0.00, 0.027],
...
#latex2.DrawLatex(0.94, 0.94,"5.1 fb^{-1} (7 TeV), 19.7 fb^{-1} (8 TeV), 41.4 fb^{-1} (13 TeV) ")
#latex2.DrawLatex(0.94, 0.94,"5.1 fb^{-1} (7 TeV), 19.7 fb^{-1} (8 TeV), 58.8 fb^{-1} (13 TeV) ")
latex2.DrawLatex(0.94, 0.94,"5.1 fb^{-1} (7 TeV), 19.7 fb^{-1} (8 TeV), 59.7 fb^{-1} (13 TeV) ")
