...
for obsName in observables:
    ...
    if obsName=="mass4l": obsbins = ['SigmaBin0']
    elif obsName=="pT4l": obsbins = ['SigmaBin0','SigmaBin1','SigmaBin2','SigmaBin3','SigmaBin4']
    else: obsbins = ['SigmaBin0','SigmaBin1','SigmaBin2','SigmaBin3']
    ...
    for obsbin in obsbins:
        ...
        latex2.DrawLatex(0.87, 0.95,"10.0 fb^{-1} (13 TeV)")
