...
#for card in hzz4l_4muS_13TeV_xs_bin0.txt hzz4l_4muS_13TeV_xs_bin1.txt hzz4l_4muS_13TeV_xs_bin2.txt hzz4l_4muS_13TeV_xs_bin3.txt
#do
#echo "CMS_zjets_bkgdcompo lnN - - - - - - - - 1.35" >> $card
#done

#for card in hzz4l_2e2muS_13TeV_xs_bin0.txt hzz4l_2e2muS_13TeV_xs_bin1.txt hzz4l_2e2muS_13TeV_xs_bin2.txt hzz4l_2e2muS_13TeV_xs_bin3.txt
#do
#echo "CMS_zjets_bkgdcompo lnN - - - - - - - - 1.34" >> $card
#done

#for card in hzz4l_4eS_13TeV_xs_bin0.txt hzz4l_4eS_13TeV_xs_bin1.txt hzz4l_4eS_13TeV_xs_bin2.txt hzz4l_4eS_13TeV_xs_bin3.txt
#do
