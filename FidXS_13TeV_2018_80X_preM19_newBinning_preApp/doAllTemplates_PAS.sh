...
nohup python -u runHZZFiducialXS.py  --dir="root://cmsio5.rc.ufl.edu//store/user/t2/users/rosedj1/Higgs/HZZ4l/NTuple/Run2/MC2018_M19_Mar12_4l_2018Jets_JER_bestCandLegacy" --obsName="pT4l" --obsBins="|0|15|30|45|80|120|200|13000|" --redoTemplates --templatesOnly >& templates_pT4l.log &
#nohup python -u runHZZFiducialXS.py  --dir="root://cmsio5.rc.ufl.edu//store/user/t2/users/rosedj1/Higgs/HZZ4l/NTuple/Run2/MC2018_M19_Mar12_4l_2018Jets_JER_bestCandLegacy" --obsName="pT4l" --obsBins="|0|10|20|30|45|80|120|200|13000|" --redoTemplates --templatesOnly >& templates_pT4l.log & # additional bin below 30
