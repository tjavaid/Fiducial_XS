...
def plotXS(obsName, obs_bins):    
    ...
    if (obsName == "mass4l"):
        ...
        _temp = __import__('resultsXS_'+obsName+'_v3_2016'+floatfix, globals(), locals(), ['resultsXS'], -1)
        resultsXS_2016 = _temp.resultsXS
        _temp = __import__('resultsXS_'+obsName+'_v2_2016'+floatfix, globals(), locals(), ['resultsXS'], -1)
        resultsXS_v2_2016 = _temp.resultsXS

        _temp = __import__('resultsXS_'+obsName+'_v3_2017'+floatfix, globals(), locals(), ['resultsXS'], -1)
        resultsXS_2017 = _temp.resultsXS
        _temp = __import__('resultsXS_'+obsName+'_v2_2017'+floatfix, globals(), locals(), ['resultsXS'], -1)
        resultsXS_v2_2017 = _temp.resultsXS

        _temp = __import__('resultsXS_'+obsName+'_v3_2018'+floatfix, globals(), locals(), ['resultsXS'], -1)
        resultsXS_2018 = _temp.resultsXS
        _temp = __import__('resultsXS_'+obsName+'_v2_2018'+floatfix, globals(), locals(), ['resultsXS'], -1)
        resultsXS_v2_2018 = _temp.resultsXS
    ...
    systematics_hi_2016 = []
    systematics_lo_2016 = []
    systematics_hi2_2016 = []
    systematics_lo2_2016 = []
    data_hi_allunc_2016 = []
    data_lo_allunc_2016 = []
    stat_hi_2016 = []
    stat_lo_2016 = []
    ...
    systematics_hi_2017 = []
    systematics_lo_2017 = []
    systematics_hi2_2017 = []
    systematics_lo2_2017 = []
    data_hi_allunc_2017 = []
    data_lo_allunc_2017 = []
    stat_hi_2017 = []
    stat_lo_2017 = []
    ...
    systematics_hi_2018 = []
    systematics_lo_2018 = []
    systematics_hi2_2018 = []
    systematics_lo2_2018 = []
    data_hi_allunc_2018 = []
    data_lo_allunc_2018 = []
    stat_hi_2018 = []
    stat_lo_2018 = []
    ...
    for obsBin in range(nBins-1):
        ...
        # Data
        data_2016.append(0.0)
        data_hi_2016.append(0.0)
        data_lo_2016.append(0.0)        
        # Systematic unc
        systematics_hi_2016.append(0.0)
        systematics_lo_2016.append(0.0)
        stat_hi_2016.append(0.0)
        stat_lo_2016.append(0.0)

        # Data
        data_2017.append(0.0)
        data_hi_2017.append(0.0)
        data_lo_2017.append(0.0)
        # Systematic unc
        systematics_hi_2017.append(0.0)
        systematics_lo_2017.append(0.0)
        stat_hi_2017.append(0.0)
        stat_lo_2017.append(0.0)

        # Data
        data_2018.append(0.0)
        data_hi_2018.append(0.0)
        data_lo_2018.append(0.0)
        # Systematic unc
        systematics_hi_2018.append(0.0)
        systematics_lo_2018.append(0.0)
        stat_hi_2018.append(0.0)
        stat_lo_2018.append(0.0)
        ...
        if (opt.UNBLIND):
            ...
            data_2016[obsBin] = resultsXS_2016[datamodel+"_"+obsName+"_genbin"+str(obsBin)]["central"]        
            data_hi_2016[obsBin] = resultsXS_2016[datamodel+"_"+obsName+"_genbin"+str(obsBin)]["uncerUp"]
            data_lo_2016[obsBin] = -1.0*resultsXS_2016[datamodel+"_"+obsName+"_genbin"+str(obsBin)]["uncerDn"]        

            data_2017[obsBin] = resultsXS_2017[datamodel+"_"+obsName+"_genbin"+str(obsBin)]["central"]        
            data_hi_2017[obsBin] = resultsXS_2017[datamodel+"_"+obsName+"_genbin"+str(obsBin)]["uncerUp"]
            data_lo_2017[obsBin] = -1.0*resultsXS_2017[datamodel+"_"+obsName+"_genbin"+str(obsBin)]["uncerDn"]        

            data_2018[obsBin] = resultsXS_2018[datamodel+"_"+obsName+"_genbin"+str(obsBin)]["central"]        
            data_hi_2018[obsBin] = resultsXS_2018[datamodel+"_"+obsName+"_genbin"+str(obsBin)]["uncerUp"]
            data_lo_2018[obsBin] = -1.0*resultsXS_2018[datamodel+"_"+obsName+"_genbin"+str(obsBin)]["uncerDn"]        
        ...
        if (opt.UNBLIND):
            ...
            systematics_hi_2016[obsBin] = sqrt(max(0.0,resultsXS_2016["SM_125_"+obsName+"_genbin"+str(obsBin)]["uncerUp"]**2-resultsXS_2016["SM_125_"+obsName+"_genbin"+str(obsBin)+'_statOnly']["uncerUp"]**2))
            systematics_lo_2016[obsBin] = sqrt(max(0.0,resultsXS_2016["SM_125_"+obsName+"_genbin"+str(obsBin)]["uncerDn"]**2-resultsXS_2016["SM_125_"+obsName+"_genbin"+str(obsBin)+'_statOnly']["uncerDn"]**2))

            systematics_hi_2017[obsBin] = sqrt(max(0.0,resultsXS_2017["SM_125_"+obsName+"_genbin"+str(obsBin)]["uncerUp"]**2-resultsXS_2017["SM_125_"+obsName+"_genbin"+str(obsBin)+'_statOnly']["uncerUp"]**2))
            systematics_lo_2017[obsBin] = sqrt(max(0.0,resultsXS_2017["SM_125_"+obsName+"_genbin"+str(obsBin)]["uncerDn"]**2-resultsXS_2017["SM_125_"+obsName+"_genbin"+str(obsBin)+'_statOnly']["uncerDn"]**2))

            systematics_hi_2018[obsBin] = sqrt(max(0.0,resultsXS_2018["SM_125_"+obsName+"_genbin"+str(obsBin)]["uncerUp"]**2-resultsXS_2018["SM_125_"+obsName+"_genbin"+str(obsBin)+'_statOnly']["uncerUp"]**2))
            systematics_lo_2018[obsBin] = sqrt(max(0.0,resultsXS_2018["SM_125_"+obsName+"_genbin"+str(obsBin)]["uncerDn"]**2-resultsXS_2018["SM_125_"+obsName+"_genbin"+str(obsBin)+'_statOnly']["uncerDn"]**2))
            ...
            stat_hi_2016[obsBin] = resultsXS_2016["SM_125_"+obsName+"_genbin"+str(obsBin)+'_statOnly']["uncerUp"]
            stat_lo_2016[obsBin] = resultsXS_2016["SM_125_"+obsName+"_genbin"+str(obsBin)+'_statOnly']["uncerDn"]

            stat_hi_2017[obsBin] = resultsXS_2017["SM_125_"+obsName+"_genbin"+str(obsBin)+'_statOnly']["uncerUp"]
            stat_lo_2017[obsBin] = resultsXS_2017["SM_125_"+obsName+"_genbin"+str(obsBin)+'_statOnly']["uncerDn"]

            stat_hi_2018[obsBin] = resultsXS_2018["SM_125_"+obsName+"_genbin"+str(obsBin)+'_statOnly']["uncerUp"]
            stat_lo_2018[obsBin] = resultsXS_2018["SM_125_"+obsName+"_genbin"+str(obsBin)+'_statOnly']["uncerDn"]
    ...
    if (obsName=="mass4l"):
        for channel in ['2e2mu','4mu','4e']:
            ...
            data_2016[bin] = resultsXS_v2_2016[datamodel+"_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["central"]
            data_hi_2016[bin] = resultsXS_v2_2016[datamodel+"_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerUp"]
            data_lo_2016[bin] = -1.0*resultsXS_v2_2016[datamodel+"_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerDn"]

            data_2017[bin] = resultsXS_v2_2017[datamodel+"_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["central"]
            data_hi_2017[bin] = resultsXS_v2_2017[datamodel+"_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerUp"]
            data_lo_2017[bin] = -1.0*resultsXS_v2_2017[datamodel+"_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerDn"]

            data_2018[bin] = resultsXS_v2_2018[datamodel+"_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["central"]
            data_hi_2018[bin] = resultsXS_v2_2018[datamodel+"_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerUp"]
            data_lo_2018[bin] = -1.0*resultsXS_v2_2018[datamodel+"_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerDn"]
            ...
            if (opt.UNBLIND):
                ...
                systematics_hi_2016[bin] = sqrt(resultsXS_v2_2016["SM_125_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerUp"]**2-resultsXS_v2_2016["SM_125_"+obsName+"_"+channel+"_genbin"+str(obsBin)+'_statOnly']["uncerUp"]**2)
                systematics_lo_2016[bin] = sqrt(resultsXS_v2_2016["SM_125_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerDn"]**2-resultsXS_v2_2016["SM_125_"+obsName+"_"+channel+"_genbin"+str(obsBin)+'_statOnly']["uncerDn"]**2)

                systematics_hi_2017[bin] = sqrt(resultsXS_v2_2017["SM_125_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerUp"]**2-resultsXS_v2_2017["SM_125_"+obsName+"_"+channel+"_genbin"+str(obsBin)+'_statOnly']["uncerUp"]**2)
                systematics_lo_2017[bin] = sqrt(resultsXS_v2_2017["SM_125_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerDn"]**2-resultsXS_v2_2017["SM_125_"+obsName+"_"+channel+"_genbin"+str(obsBin)+'_statOnly']["uncerDn"]**2)

                systematics_hi_2018[bin] = sqrt(resultsXS_v2_2018["SM_125_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerUp"]**2-resultsXS_v2_2018["SM_125_"+obsName+"_"+channel+"_genbin"+str(obsBin)+'_statOnly']["uncerUp"]**2)
                systematics_lo_2018[bin] = sqrt(resultsXS_v2_2018["SM_125_"+obsName+"_"+channel+"_genbin"+str(obsBin)]["uncerDn"]**2-resultsXS_v2_2018["SM_125_"+obsName+"_"+channel+"_genbin"+str(obsBin)+'_statOnly']["uncerDn"]**2)
    ...
    print 'sys_hi',systematics_hi
    print 'sys_lo',systematics_lo

    print 'data 2016',data_2016
    print 'data_hi_2016',data_hi_2016
    print 'data_lo_2016',data_lo_2016
    print 'stat_hi_2016',stat_hi_2016
    print 'stat_lo_2016',stat_lo_2016
    print 'sys_hi_2016',systematics_hi_2016
    print 'sys_lo_2016',systematics_lo_2016

    print 'data 2017',data_2017
    print 'data_hi_2017',data_hi_2017
    print 'data_lo_2017',data_lo_2017
    print 'stat_hi_2017',stat_hi_2017
    print 'stat_lo_2017',stat_lo_2017
    print 'sys_hi_2017',systematics_hi_2017
    print 'sys_lo_2017',systematics_lo_2017

    print 'data 2018',data_2018
    print 'data_hi_2018',data_hi_2018
    print 'data_lo_2018',data_lo_2018
    print 'stat_hi_2018',stat_hi_2018
    print 'stat_lo_2018',stat_lo_2018
    print 'sys_hi_2018',systematics_hi_2018
    print 'sys_lo_2018',systematics_lo_2018
    ...
    if (obsName=="mass4l"):
        ...
        #a_observable_comb  = array('d',[0.65+i for i in range(0,4)])
        a_observable_comb  = array('d',[0.35+i for i in range(0,4)])
        v_observable_comb    = TVectorD(len(a_observable_comb),a_observable_comb)

        #a_observable_2016  = array('d',[0.35+i for i in range(0,4)])
        a_observable_2016  = array('d',[0.65+i for i in range(0,4)])
        v_observable_2016    = TVectorD(len(a_observable_2016),a_observable_2016)

        #a_observable_2017  = array('d',[0.45+i for i in range(0,4)])
        a_observable_2017  = array('d',[0.55+i for i in range(0,4)])
        v_observable_2017    = TVectorD(len(a_observable_2017),a_observable_2017)

        #a_observable_2018  = array('d',[0.55+i for i in range(0,4)])
        a_observable_2018  = array('d',[0.45+i for i in range(0,4)])
        v_observable_2018    = TVectorD(len(a_observable_2018),a_observable_2018)
        ...
        a_data_2016 = array('d',[data_2016[0],data_2016[1],data_2016[2],data_2016[3]])
        v_data_2016 = TVectorD(len(a_data_2016),a_data_2016)
        a_data_hi_2016 = array('d',[data_hi_2016[0],data_hi_2016[1],data_hi_2016[2],data_hi_2016[3]])
        v_data_hi_2016 = TVectorD(len(a_data_hi_2016),a_data_hi_2016)
        a_data_lo_2016 = array('d',[data_lo_2016[0],data_lo_2016[1],data_lo_2016[2],data_lo_2016[3]])
        v_data_lo_2016 = TVectorD(len(a_data_lo_2016),a_data_lo_2016)
        
        a_systematics_hi_2016 = array('d',[systematics_hi_2016[0],systematics_hi_2016[1],systematics_hi_2016[2],systematics_hi_2016[3]])
        v_systematics_hi_2016 = TVectorD(len(a_systematics_hi_2016),a_systematics_hi_2016)
        a_systematics_lo_2016 = array('d',[systematics_lo_2016[0],systematics_lo_2016[1],systematics_lo_2016[2],systematics_lo_2016[3]])
        v_systematics_lo_2016 = TVectorD(len(a_systematics_lo_2016),a_systematics_lo_2016) 

        a_data_2017 = array('d',[data_2017[0],data_2017[1],data_2017[2],data_2017[3]])
        v_data_2017 = TVectorD(len(a_data_2017),a_data_2017)
        a_data_hi_2017 = array('d',[data_hi_2017[0],data_hi_2017[1],data_hi_2017[2],data_hi_2017[3]])
        v_data_hi_2017 = TVectorD(len(a_data_hi_2017),a_data_hi_2017)
        a_data_lo_2017 = array('d',[data_lo_2017[0],data_lo_2017[1],data_lo_2017[2],data_lo_2017[3]])
        v_data_lo_2017 = TVectorD(len(a_data_lo_2017),a_data_lo_2017)
        
        a_systematics_hi_2017 = array('d',[systematics_hi_2017[0],systematics_hi_2017[1],systematics_hi_2017[2],systematics_hi_2017[3]])
        v_systematics_hi_2017 = TVectorD(len(a_systematics_hi_2017),a_systematics_hi_2017)
        a_systematics_lo_2017 = array('d',[systematics_lo_2017[0],systematics_lo_2017[1],systematics_lo_2017[2],systematics_lo_2017[3]])
        v_systematics_lo_2017 = TVectorD(len(a_systematics_lo_2017),a_systematics_lo_2017) 

        a_data_2018 = array('d',[data_2018[0],data_2018[1],data_2018[2],data_2018[3]])
        v_data_2018 = TVectorD(len(a_data_2018),a_data_2018)
        a_data_hi_2018 = array('d',[data_hi_2018[0],data_hi_2018[1],data_hi_2018[2],data_hi_2018[3]])
        v_data_hi_2018 = TVectorD(len(a_data_hi_2018),a_data_hi_2018)
        a_data_lo_2018 = array('d',[data_lo_2018[0],data_lo_2018[1],data_lo_2018[2],data_lo_2018[3]])
        v_data_lo_2018 = TVectorD(len(a_data_lo_2018),a_data_lo_2018)
        
        a_systematics_hi_2018 = array('d',[systematics_hi_2018[0],systematics_hi_2018[1],systematics_hi_2018[2],systematics_hi_2018[3]])
        v_systematics_hi_2018 = TVectorD(len(a_systematics_hi_2018),a_systematics_hi_2018)
        a_systematics_lo_2018 = array('d',[systematics_lo_2018[0],systematics_lo_2018[1],systematics_lo_2018[2],systematics_lo_2018[3]])
        v_systematics_lo_2018 = TVectorD(len(a_systematics_lo_2018),a_systematics_lo_2018) 
    ...
    g_data = TGraphAsymmErrors(v_observable_comb,v_data,v_zeros,v_zeros,v_data_lo,v_data_hi)
    g_data.SetMarkerColor(ROOT.kBlack)
    g_data.SetLineColor(ROOT.kBlack)
    g_data.SetLineWidth(2)
    #g_data.SetMarkerStyle(20)
    g_data.SetMarkerStyle(33)
    #g_data.SetMarkerSize(2.5)
    g_data.SetMarkerSize(4.3)

    g_data_e0 = TGraphAsymmErrors(v_observable_comb,v_data,v_zeros,v_zeros,v_zeros,v_zeros)
    ...
    g_data_e0.SetMarkerStyle(33)
    #g_data_e0.SetMarkerSize(2.5)
    g_data_e0.SetMarkerSize(4.3)

#    g_data_2016 = TGraphAsymmErrors(v_observable_2016,v_data_2016,v_zeros,v_zeros,v_data_lo_2016,v_data_hi_2016)
#    g_data_2016.SetMarkerColor(ROOT.kBlack)
#    g_data_2016.SetLineColor(ROOT.kBlack)
#    g_data_2016.SetLineWidth(2)
#    g_data_2016.SetMarkerStyle(21)
#    g_data_2016.SetMarkerSize(2.5)
#
#    g_data_e0_2016 = TGraphAsymmErrors(v_observable_2016,v_data_2016,v_zeros,v_zeros,v_zeros,v_zeros)
#    g_data_e0_2016.SetMarkerColor(ROOT.kBlack)
#    g_data_e0_2016.SetLineColor(ROOT.kBlack)
#    g_data_e0_2016.SetLineWidth(2)
#    g_data_e0_2016.SetMarkerStyle(21)
#    g_data_e0_2016.SetMarkerSize(2.5)
#
#
#    g_data_2017 = TGraphAsymmErrors(v_observable_2017,v_data_2017,v_zeros,v_zeros,v_data_lo_2017,v_data_hi_2017)
#    g_data_2017.SetMarkerColor(ROOT.kBlack)
#    g_data_2017.SetLineColor(ROOT.kBlack)
#    g_data_2017.SetLineWidth(2)
#    g_data_2017.SetMarkerStyle(22)
#    g_data_2017.SetMarkerSize(3.0)
#
#    g_data_e0_2017 = TGraphAsymmErrors(v_observable_2017,v_data_2017,v_zeros,v_zeros,v_zeros,v_zeros)
#    g_data_e0_2017.SetMarkerColor(ROOT.kBlack)
#    g_data_e0_2017.SetLineColor(ROOT.kBlack)
#    g_data_e0_2017.SetLineWidth(2)
#    g_data_e0_2017.SetMarkerStyle(22)
#    g_data_e0_2017.SetMarkerSize(3.0)


    g_data_2018 = TGraphAsymmErrors(v_observable_2018,v_data_2018,v_zeros,v_zeros,v_data_lo_2018,v_data_hi_2018)
    g_data_2018.SetMarkerColor(ROOT.kBlack)
    g_data_2018.SetLineColor(ROOT.kBlack)
    g_data_2018.SetLineWidth(2)
    #g_data_2018.SetMarkerStyle(33)
    g_data_2018.SetMarkerStyle(26)
    #g_data_2018.SetMarkerSize(4.0)
    g_data_2018.SetMarkerSize(3.2)

    g_data_e0_2018 = TGraphAsymmErrors(v_observable_2018,v_data_2018,v_zeros,v_zeros,v_zeros,v_zeros)
    g_data_e0_2018.SetMarkerColor(ROOT.kBlack)
    g_data_e0_2018.SetLineColor(ROOT.kBlack)
    g_data_e0_2018.SetLineWidth(2)
    #g_data_e0_2018.SetMarkerStyle(33)
    g_data_e0_2018.SetMarkerStyle(26)
    #g_data_e0_2018.SetMarkerSize(4.0)
    g_data_e0_2018.SetMarkerSize(3.2)
    ...
    g_data_e0_2017.SetLineWidth(2)
    #g_data_e0_2017.SetMarkerStyle(22)
    g_data_e0_2017.SetMarkerStyle(24)
    g_data_e0_2017.SetMarkerSize(3.0)
    ...
    g_data_2016.SetLineWidth(2)
    #g_data_2016.SetMarkerStyle(21)
    #g_data_2016.SetMarkerStyle(27)
    g_data_2016.SetMarkerStyle(25)
    g_data_2016.SetMarkerSize(2.5)
    ...
    g_data_e0_2016.SetLineWidth(2)
    #g_data_e0_2016.SetMarkerStyle(21)
    #g_data_e0_2016.SetMarkerStyle(27)
    g_data_e0_2016.SetMarkerStyle(25)
    g_data_e0_2016.SetMarkerSize(2.5)
    ...
    g_systematics = TGraphAsymmErrors(v_observable_comb,v_data,v_zeros,v_zeros,v_systematics_lo,v_systematics_hi)
...
#    g_systematics_2016 = TGraphAsymmErrors(v_observable_2016,v_data_2016,v_zeros,v_zeros,v_systematics_lo_2016,v_systematics_hi_2016)
#    g_systematics_2016.SetLineWidth(5)
#    g_systematics_2016.SetMarkerColor(ROOT.kRed)
#    g_systematics_2016.SetLineColor(ROOT.kRed)
#    g_systematics_2016.SetFillColor(ROOT.kRed)
#
#    g_systematics_2017 = TGraphAsymmErrors(v_observable_2017,v_data_2017,v_zeros,v_zeros,v_systematics_lo_2017,v_systematics_hi_2017)
#    g_systematics_2017.SetLineWidth(5)
#    g_systematics_2017.SetMarkerColor(ROOT.kRed)
#    g_systematics_2017.SetLineColor(ROOT.kRed)
#    g_systematics_2017.SetFillColor(ROOT.kRed)

    g_systematics_2018 = TGraphAsymmErrors(v_observable_2018,v_data_2018,v_zeros,v_zeros,v_systematics_lo_2018,v_systematics_hi_2018)
    g_systematics_2018.SetLineWidth(5)
    g_systematics_2018.SetMarkerColor(ROOT.kRed)
    g_systematics_2018.SetLineColor(ROOT.kRed)
    g_systematics_2018.SetFillColor(ROOT.kRed)
    ...
    legend = TLegend(.44,.55,.85,.90)
    #legend . SetNColumns(2)
    #legend . SetTextSize(0.026)
    #legend . SetTextSize(0.029) # less info for XH
    legend . SetTextSize(0.025) # shrink margins
    #if (opt.UNBLIND): legend . AddEntry(g_data , "Combined Data (stat. #oplus sys. unc.)", "ep")
    #if (opt.UNBLIND): legend . AddEntry(g_data , "Combined Data (stat #oplus sys)", "ep")
    #if (opt.UNBLIND): legend . AddEntry(g_data , "Combined Data (137 fb^{-1} stat #oplus sys)", "ep")
    #if (opt.UNBLIND): legend . AddEntry(g_data , "Combined Data (stat #oplus sys, 137 fb^{-1})", "ep")
    #if (opt.UNBLIND): legend . AddEntry(g_data , "Combined Data, 137 fb^{-1} (stat #oplus sys)", "ep")
    if (opt.UNBLIND): legend . AddEntry(g_data , "Combined Data, 137 fb^{-1} (stat #oplus syst)", "ep")
    #if (opt.UNBLIND): legend . AddEntry(g_data_2018 , "2018 Data (59.7 fb^{-1})", "ep")
    #if (opt.UNBLIND): legend . AddEntry(g_data_2018 , "2018 Data (59.7 fb^{-1} stat #oplus sys)", "ep")
    #if (opt.UNBLIND): legend . AddEntry(g_data_2018 , "2018 Data (stat #oplus sys, 59.7 fb^{-1})", "ep")
    #if (opt.UNBLIND): legend . AddEntry(g_data_2018 , "2018 Data, 59.7 fb^{-1} (stat #oplus sys)", "ep")
    if (opt.UNBLIND): legend . AddEntry(g_data_2018 , "2018 Data, 59.7 fb^{-1} (stat #oplus syst)", "ep")
    #if (opt.UNBLIND): legend . AddEntry(g_data_2017 , "2017 Data (41.5 fb^{-1})", "ep")
    #if (opt.UNBLIND): legend . AddEntry(g_data_2017 , "2017 Data (41.5 fb^{-1} stat #oplus sys)", "ep")
    #if (opt.UNBLIND): legend . AddEntry(g_data_2017 , "2017 Data (stat #oplus sys, 41.5 fb^{-1})", "ep")
    #if (opt.UNBLIND): legend . AddEntry(g_data_2017 , "2017 Data, 41.5 fb^{-1} (stat #oplus sys)", "ep")
    if (opt.UNBLIND): legend . AddEntry(g_data_2017 , "2017 Data, 41.5 fb^{-1} (stat #oplus syst)", "ep")
    #if (opt.UNBLIND): legend . AddEntry(g_data_2016 , "2016 Data (35.9 fb^{-1})", "ep")
    #if (opt.UNBLIND): legend . AddEntry(g_data_2016 , "2016 Data (35.9 fb^{-1} stat #oplus sys)", "ep")
    #if (opt.UNBLIND): legend . AddEntry(g_data_2016 , "2016 Data (stat #oplus sys, 35.9 fb^{-1})", "ep")
    #if (opt.UNBLIND): legend . AddEntry(g_data_2016 , "2016 Data, 35.9 fb^{-1} (stat #oplus sys)", "ep")
    if (opt.UNBLIND): legend . AddEntry(g_data_2016 , "2016 Data, 35.9 fb^{-1} (stat #oplus syst)", "ep")
#    if (opt.UNBLIND): legend . AddEntry(g_data_2017 , "2017 Data (41.5 fb^{-1})", "ep")
#    if (opt.UNBLIND): legend . AddEntry(g_data_2018 , "2018 Data (59.7 fb^{-1})", "ep")
    ...
    g_data_2018.Draw("psameZ0")
    g_systematics_2018.Draw("psameZ0")
    g_data_e0_2018.Draw("psame")

#    g_data_2016.Draw("psameZ0")
#    g_systematics_2016.Draw("psameZ0")
#    g_data_e0_2016.Draw("psame")

    g_data_2017.Draw("psameZ0")
    g_systematics_2017.Draw("psameZ0")
    g_data_e0_2017.Draw("psame")
...
#    g_data_e0_2018.Draw("psame")
    ...
    if (not opt.LUMISCALE=="1.0"):
        ...
        #latex2.DrawLatex(0.94, 0.94,"137 fb^{-1} (13 TeV)")
        #latex2.DrawLatex(0.94, 0.94,"13 TeV")
        latex2.DrawLatex(0.94, 0.94,"LHC Run 2 (13 TeV)")
    ...
    if ("2p5" in obsName):
        ...
        if ("njets" in obsName):
            ...
            latex2.DrawLatex(0.92, 0.61,"p_{T}(jet) > 30 GeV, |#eta^{j}| < 2.5")
        if ("pt_leading" in obsName):
            #latex2.DrawLatex(0.86, 0.61,"p_{T}(jet) > 30 GeV, |#eta(jet)| < 2.5")
            latex2.DrawLatex(0.86, 0.61,"p_{T}(jet) > 30 GeV, |#eta^{j}| < 2.5")
...
#    c.SaveAs('plots/'+obsName+'_unfoldwith_'+datamodel+set_log+'_ThreeYears.pdf')
#    c.SaveAs('plots/'+obsName+'_unfoldwith_'+datamodel+set_log+'_ThreeYears.png')
#    c.SaveAs('plots/'+obsName+'_unfoldwith_'+datamodel+set_log+'_ThreeYears.root')
#    c.SaveAs('plots/'+obsName+'_unfoldwith_'+datamodel+set_log+'_ThreeYears.C')
#


    c.SaveAs('plots_'+date+'/'+obsName+'_unfoldwith_'+datamodel+set_log+'_ThreeYears.pdf')
    c.SaveAs('plots_'+date+'/'+obsName+'_unfoldwith_'+datamodel+set_log+'_ThreeYears.png')
    c.SaveAs('plots_'+date+'/'+obsName+'_unfoldwith_'+datamodel+set_log+'_ThreeYears.root')
    c.SaveAs('plots_'+date+'/'+obsName+'_unfoldwith_'+datamodel+set_log+'_ThreeYears.C')
