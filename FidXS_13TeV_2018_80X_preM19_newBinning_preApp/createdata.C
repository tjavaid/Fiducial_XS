...
void createdata(bool useRefit=false) {
    ...
    //TFile *oldfile = new TFile("/scratch/osg/dsperka/Run2/HZZ4l/SubmitArea_13TeV/rootfiles_Data_20160220/Data_passedZ4l.root","READ");
    //TFile *oldfile = new TFile("/cms/data/store/user/t2/users/dsperka/rootfiles_Data80X_20160725/Data_2016_13fb_4lskim.root","READ");
    //TFile *oldfile = new TFile("/scratch/osg/dsperka/Run2/HZZ4l/CMSSW_8_0_11/src/pickedEvents_13fb_newEGScale_All.root","READ");
    TFile *oldfile = new TFile("/raid/raid5/dsperka/Run2/HZZ4l/SubmitArea_13TeV/Ana_ZZ4L_80X/Data_Run2016-03Feb2017_hzz4l_bestCandLegacy.root","READ");
   ...
   */
   ...
   TFile *newfile = new TFile("data_13TeV_old.root","recreate");
