void mass4l_unfoldwith_SM_125_asimov()
{
//=========Macro generated from canvas: c/mass4l
//=========  (Fri Sep 17 19:35:49 2021) by ROOT version6.02/05
   TCanvas *c = new TCanvas("c", "mass4l",0,0,1400,1400);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   c->SetHighLightColor(2);
   c->Range(-0.923077,-0.8320736,4.205128,5.569262);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
