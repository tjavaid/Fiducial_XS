...
##    save = save+'_41pt4fb'
    ...
    List = [
	'GluGluToContinToZZTo2e2mu_M125_2018_slimmed',
	'GluGluToContinToZZTo4mu_M125_2018_slimmed',
	'GluGluToContinToZZTo4e_M125_2018_slimmed',
	'ZZTo4L_powheg_ext1_slimmed',
        '2018_noDuplicates'
        ]
    ...
    for Sample in List:
        ...
        if (Sample.startswith('2018_')):   # by TJ
...
##            weight = '(genWeight*crossSection*dataMCWeight*pileupWeight*'+str(lumi2017)+'/'+str(sumw[Sample])+')'
            ...
            # hard coded weights
	    if (Sample.startswith('GluGluToContinToZZTo4e')):crossSection='(0.00158549)'   
	    elif (Sample.startswith('GluGluToContinToZZTo2e2mu')):crossSection='(0.0031942)'   
	    elif (Sample.startswith('GluGluToContinToZZTo4mu')):crossSection='(0.00158549)'   
	    elif (Sample.startswith('ZZTo4L')):crossSection='(1.256)'   
	    print "the sample is ",Sample, "cross section is   ",crossSection
            #weight = '(genWeight*crossSection*dataMCWeight*pileupWeight*'+str(lumi2018)+'/'+str(sumw[Sample])+')'

#            weight = '(genWeight*'+crossSection+'*dataMCWeight*pileupWeight*'+str(lumi2018)+'/'+str(sumw[Sample])+')'
            #weight = '(genWeight*'+crossSection+'*dataMCWeight_new*pileupWeight*'+str(lumi2018)+'/'+str(sumw[Sample])+')'
            weight = '(genWeight*'+crossSection+'*dataMCWeight*pileupWeight*'+str(lumi2018)+'/'+str(sumw[Sample])+')'
...
#observables=['mass4l','pt_leadingjet_pt30_eta2p5','rapidity4l'] #,'njets_pt30_eta4p7','pt_leadingjet_pt30_eta4p7']
#observables=['mass4l','pt_leadingjet_pt30_eta2p5','pT4l'] #,'njets_pt30_eta4p7','pt_leadingjet_pt30_eta4p7']
observables=['mass4l']
