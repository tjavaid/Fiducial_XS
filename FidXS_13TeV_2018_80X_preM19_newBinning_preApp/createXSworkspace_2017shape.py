...
#    lumi = RooRealVar("lumi_13","lumi_13", 41.4)
    ...
    if (obsName!="mass4lREFIT"):
        if (channel=='2e2mu'):
            ...
            CMS_zz4l_alpha_3_centralValue = RooFormulaVar("CMS_zz4l_alpha_3_centralValue","CMS_zz4l_alpha_3_centralValue","(0.967963+(-0.0047248)*(@0-125))",RooArgList(MH))
            CMS_zz4l_n_3_8_centralValue = RooFormulaVar("CMS_zz4l_n_3_8_centralValue","CMS_zz4l_n_3_8_centralValue","(3.69774+(0)*(@0-125))*(1+@1)",RooArgList(MH,CMS_zz4l_n_sig_3_8))
            CMS_zz4l_alpha2_3_centralValue = RooFormulaVar("CMS_zz4l_alpha2_3_centralValue","CMS_zz4l_alpha2_3_centralValue","(1.51606+(-0.000272186)*(@0-125))",RooArgList(MH))
            CMS_zz4l_n2_3_8_centralValue = RooFormulaVar("CMS_zz4l_n2_3_8_centralValue","CMS_zz4l_n2_3_8_centralValue","(6.01048+(0)*(@0-125))",RooArgList(MH))
        ...
        if (channel=='4e'):
            ...
            CMS_zz4l_alpha_2_centralValue = RooFormulaVar("CMS_zz4l_alpha_2_centralValue","CMS_zz4l_alpha_2_centralValue","(0.972669+(-0.00597402)*(@0-125))",RooArgList(MH))
            CMS_zz4l_n_2_8_centralValue = RooFormulaVar("CMS_zz4l_n_2_8_centralValue","CMS_zz4l_n_2_8_centralValue","(5.05142+(0)*(@0-125))*(1+@1)",RooArgList(MH,CMS_zz4l_n_sig_2_8))
            CMS_zz4l_alpha2_2_centralValue = RooFormulaVar("CMS_zz4l_alpha2_2_centralValue","CMS_zz4l_alpha2_2_centralValue","(1.62625+(0.0121146)*(@0-125))",RooArgList(MH))
            CMS_zz4l_n2_2_8_centralValue = RooFormulaVar("CMS_zz4l_n2_2_8_centralValue","CMS_zz4l_n2_2_8_centralValue","(6.30057+(0)*(@0-125))",RooArgList(MH))

        if (channel=='4mu'):

            CMS_zz4l_mean_sig_1_8_centralValue = RooFormulaVar("CMS_zz4l_mean_sig_1_8_centralValue","CMS_zz4l_mean_sig_1_8_centralValue", \
                                                                   "(124.82+(-0.000560694+1)*(@0-125)) + @0*@1*@2",RooArgList(MH,CMS_zz4l_mean_m_sig,CMS_zz4l_mean_m_err_1_8))
            ...
            CMS_zz4l_alpha_1_centralValue = RooFormulaVar("CMS_zz4l_alpha_1_centralValue","CMS_zz4l_alpha_1_centralValue","(1.22997+(0.00256332)*(@0-125))",RooArgList(MH))
            CMS_zz4l_n_1_8_centralValue = RooFormulaVar("CMS_zz4l_n_1_8_centralValue","CMS_zz4l_n_1_8_centralValue","(2.07185+(0)*(@0-125))*(1+@1)",RooArgList(MH,CMS_zz4l_n_sig_1_8))
            CMS_zz4l_alpha2_1_centralValue = RooFormulaVar("CMS_zz4l_alpha2_1_centralValue","CMS_zz4l_alpha2_1_centralValue","(1.92338+(0.0109082)*(@0-125))",RooArgList(MH))
            CMS_zz4l_n2_1_8_centralValue = RooFormulaVar("CMS_zz4l_n2_1_8_centralValue","CMS_zz4l_n2_1_8_centralValue","(2.90336+(0)*(@0-125))",RooArgList(MH))
